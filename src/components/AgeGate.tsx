...
export function AgeGate() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/95 backdrop-blur-xl px-4 animate-fade-in">
      <div className="glass max-w-lg w-full rounded-2xl p-8 md:p-10 text-center glow-gold">
        <div className="text-xs tracking-[0.3em] text-accent uppercase mb-4">Acces Restricționat</div>
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          Ai împlinit <span className="text-shimmer">18 ani</span>?
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Button size="lg" onClick={accept} className="bg-primary text-primary-foreground hover:opacity-90 font-semibold">
            Da, am peste 18 ani
          </Button>
